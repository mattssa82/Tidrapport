...
(function(){
  ...
  // Frånvaro (ska bli gul/orange_absence, aldrig grön)
  const ABSENCE = [
    "vab",
    "sjuk",
    "sjuk-tim",
  ...
  function classifyDayType(dateStr /*, settings */){
    ...
    // OBS: vi hanterar ev röda dagar centralt senare om vi lägger tillbaka custom-lista
    return "vardag";
  }
  ...
  // Bygg karta dag -> status
  function buildDayStatusMap(monthRows, yearNum, monthNum){
    const byDate={};
    (monthRows||[]).forEach(r=>{
      if(!r.datum) return;
