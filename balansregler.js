...
//
// Bygger status per dag ("grön", "orange_under", "orange_absence", "saknas", "helg", "röddag")
// Används både för radfärg i månadslistan och för larmtabellen.
