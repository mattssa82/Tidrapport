...
// Bygger på platt struktur {datum, projekt, kategori, tid, kortid, beskrivning}
  ...
  window.exportYearImpl = function(rows, settings){
    try{
      const header=[
        ...
        "Semester","ATF","VAB","FL","Sjuk","Trakt","Körtid"
      ];
