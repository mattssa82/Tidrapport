// ===== backup.js – Backup & återställning (Tidrapport Next Q4 2025) =====
(() => {
  const STORAGE_KEY = "tidrapport:data";
  const SETTINGS_KEY = "tidrapport:cfg";
  let lastBackupAt = 0;
  const BACKUP_INTERVAL_MS = 60000; // debounce 60 s
  ...
  console.log("%cBackup.js laddad ✅ (Q4 2025)", "color:green");
})();