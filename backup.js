...
(function(){
  ...
  // Auto-backup: körs av app.js -> saveData() som kallar autoLocalBackup()
  // Vi skriver en timestampad snapshot i localStorage om autoBackup är på.
    ...
    reader.onload = e=>{
      try{
        ...
        if(parsed && parsed.data){
          ...
          // gammalt format direkt med månadsobjekt
          payload.data = parsed;
          payload.settings = {};
        }
